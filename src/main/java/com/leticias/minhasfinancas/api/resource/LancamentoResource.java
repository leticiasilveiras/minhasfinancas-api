package com.leticias.minhasfinancas.api.resource;
...
import com.leticias.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.leticias.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity buscar(
		...
		Lançamentos lancamentoFiltro = new Lançamentos();
		...
		List<Lançamentos> lancamentos = service.buscar(lancamentoFiltro);
	...
	public ResponseEntity salvar(@RequestBody LancamentoDTO dto) {
		try {
			Lançamentos entidade = converter(dto);
	...
	public ResponseEntity atualizar (@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		return service.obterPorId(id).map(entity -> {
			try {
				Lançamentos lancamento = converter(dto);
	...
	private Lançamentos converter(LancamentoDTO dto) {
